...
The best fully valid v2 rows are Gemini 3.1 Flash-lite (`0.573`), Gemini 3 Flash (`0.596`), Gemma 4 26B A4B (`0.813`), Qwen 3.5 Plus (`0.958`), and DeepSeek V4 Flash (`1.025`).
...
On the six overlapping context-aware participants, the original prompt average was `1.216` and the v2 prompt average was `1.027`, a reduction of `0.189`. Excluding DeepSeek, the five-model average changed from `1.145` to `1.027`, a reduction of `0.118`.
